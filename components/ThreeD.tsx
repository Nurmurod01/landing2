...
export default function ParticleAIVisualization() {
  ...
  useEffect(() => {
    ...
    const drawCentralSphere = (ctx: CanvasRenderingContext2D, time: number) => {
      const centerX = getCenterX();
      const centerY = getCenterY();
      const radius = 80 + Math.sin(time * 0.002) * 8;
      ...
      gradient.addColorStop(0, "rgba(25, 60, 184, 0.9)"); // #193cb8, to‘q va ko‘rinadigan
      gradient.addColorStop(0.5, "rgba(20, 50, 160, 0.6)"); // biroz to‘qroq
      gradient.addColorStop(1, "rgba(15, 40, 130, 0.3)");
